...
public class ShopController {
    ...
    public String showProductList(
        ...
        model.addAttribute("currentSearch", null);
    ...
    @GetMapping("/sort/best-selling")
    public String showProductListOrderByBestSelling(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "12") int size,
            @RequestParam(required = false) String genders,
            @RequestParam(required = false) String brands,
        ...
        model.addAttribute("currentSort", "best-selling");
    ...
    public String showProductDetail(@PathVariable Integer id, Model model) {
        ...
        // Get the first variant that is in stock to pre-select
        Integer firstInStockVariantId = variants.stream()
                .filter(v -> v.getQuantityInStock() > 0)
                .findFirst()
