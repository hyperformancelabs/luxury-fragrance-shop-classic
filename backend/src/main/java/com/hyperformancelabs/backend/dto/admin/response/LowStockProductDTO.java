...
// Consider adding Lombok annotations like @Data, @AllArgsConstructor, @NoArgsConstructor if appropriate
// For now, keeping it as a POJO with explicit constructor and getters/setters as per original
