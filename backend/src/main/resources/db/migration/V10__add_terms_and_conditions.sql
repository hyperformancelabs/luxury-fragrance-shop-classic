...
CREATE TABLE terms_and_conditions (
    ...
    markdown_content NTEXT NOT NULL,
    last_updated DATETIME NOT NULL
);

-- Insert default terms and conditions - Using N prefix for Unicode Vietnamese characters
INSERT INTO terms_and_conditions (markdown_content, last_updated)
VALUES (
N'# 1. Giới thiệu
